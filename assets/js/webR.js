function loadWebR(options){
    ...
    if(options.PKG_URL === undefined) options.PKG_URL = "https://www.mas.ncl.ac.uk/~ngs54/webR-testing/packages/"; // "https://cdn.jsdelivr.net/gh/georgestagg/webr-ports/dist/";
